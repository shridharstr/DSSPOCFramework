...
public abstract class CheckoutPageObject {
	...
	public void enterDigitalAccessSSOR(String SSOREmail) throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='digitalAccess']/div[2]/div/a")));
	...
	public void enterDigitalAccessNonSSOR(String NonSSOREmail, String password, String Confpassword) throws InterruptedException {
		...
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#digitalAccess > div:nth-of-type(2) > div > div:nth-of-type(1) > input")));
		driver.findElement(By.cssSelector("#digitalAccess > div:nth-of-type(2) > div > div:nth-of-type(1) > input"))
				.clear();
		driver.findElement(By.cssSelector("#digitalAccess > div:nth-of-type(2) > div > div:nth-of-type(1) > input"))
		...
		wait2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='digitalAccess']/div[2]/div/a")));
		driver.findElement(By.xpath("//*[@id='digitalAccess']/div[2]/div/a")).click();
	...
	public void payWithCreditCard(String name, String cardNumber, String Month, String Year)
		...
		//Thread.sleep(5000);
		WebDriverWait wait = new WebDriverWait(driver, 10);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='payment']/div[2]/div/a")));
	...
	public void payWithMyBankAccount(String BankName, String AccountNumber, String RoutingNumber)
		...
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.linkText("Pay with my Bank Account"))); 
		...
		//Thread.sleep(4000);
		WebDriverWait wait2 = new WebDriverWait(driver, 10);
		wait2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='payment']/div[2]/div/a")));
		driver.findElement(By.xpath("//*[@id='payment']/div[2]/div/a")).click();
